...
<body class="body_pagPrincipal">
    ...
    <div class="container">
        ...
        $resultados = mostrarLivrosAlterar($codigo);
        ...
        <form method="POST" action="../control/controleLivros.php">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" value="<?= $linha['titulo'] ?>">
            </div>
            <div class="mb-3">
                <label for="autor" class="form-label">Autor</label>
                <input type="text" class="form-control" id="autor" name="autor" value="<?= $linha['autor'] ?>">
            </div>
            <div class="mb-3">
                ...
                <input type="number" step="0.1" max="10" min="0" class="form-control" id="classificacao"
                    name="classificacao" value="<?= $linha['classificacao'] ?>">
            </div>
            <input type="hidden" name="codigo" value="<?= $linha['codigo'] ?>">
            <button type="submit" class="btn btn-warning" name="opcao" value="Alterar">Alterar</button>
